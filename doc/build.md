...
Note: the master branch targets the Tang Primer 20K Lite board. Use the [dock branch](https://github.com/nand2mario/gametang/tree/dock) if you want to build for the Tang Primer 20K Dock.
