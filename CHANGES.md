...
## Version history for GAMETang - an NES emulator for Tang Primer 20K

v0.11, 2/06/2024
- Add a "Select core" menu item to switch between sgametang and gametang cores. To enable it, just put the .bin core files in the /cores directory.

v0.10, 23/05/2024
- Support SNES/NES controller, in addition to DS2.

v0.9, 7/04/2024
- This version adds the iosys softcore, which sgametang has used for a while.
    - Directory support.
    ...
    - One firmware supports both cores. The firmware in sgametang repo is updated to recognize the gametang core.
...
- This is the first GAMETang version that can operate standalone (without a PC). It is much 
...
* Needs a MiSTer SDRAM module. See [here](https://github.com/nand2mario/gametang/blob/3e79993cb50d348ecec3a7860ad9d4c9c64ea319/doc/wiring.md) 
