...
print("Since 0.7, nes2img.py is NO LONGER NEEDED. Just format your MicroSD card as FAT32. See https://github.com/nand2mario/gametang/README.md. This script will be removed later.\n")
