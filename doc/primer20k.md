...
* Launch the **Gowin Programmer** application and program either the `gametang-lite.fs` or `gametang-dock.fs` file, depending on your specific board. If your setup is correctly configured, a colorful NES palette should be displayed. 
